-- Let active admins update both the public profile row and the matching
-- Supabase Auth user. The frontend cannot safely use a service-role key, so
-- account edits that touch email/password must go through this SECURITY
-- DEFINER function.
